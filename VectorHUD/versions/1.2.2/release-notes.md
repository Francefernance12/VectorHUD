...
*Note: This is a release attempt to test the auto-updater functionality with the newly rotated cryptographic key pairs. If this works, users must use this version from now on for seamless updating.*
